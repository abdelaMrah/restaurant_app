...
import { formatDateOnly, hexToRgba, stringToVividColor } from '../../../utils/utils';
  ...
  const columns: GridColDef[] = [
    ...
    { 
      ...
      renderCell:(params: GridRenderCellParams)=>(
        ...
        variant='outlined'
        sx={{
          bgcolor: hexToRgba(stringToVividColor(params.value),.1),
          borderColor:stringToVividColor(params.value),
          color:stringToVividColor(params.value)
        }}
        />
      )
    },
    ...
    { 
      ...
      renderCell: (params: GridRenderCellParams) => (
        ...
        variant='outlined'
          ...
          sx={{
            bgcolor: hexToRgba(params.value === 'Actif' ? palette.success.main : palette.error.main, 0.05)
          }}
        />
      ),
    },
